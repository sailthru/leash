...
const blockedGhCommands = [
  ...
  {
    cmd: "gh api search/code/../../repos/owner/repo -X DELETE",
    reason: "gh api",
  },
  { cmd: "gh api search/code/../repos/x", reason: "gh api" },
  { cmd: "gh api search/code", reason: "gh api" },
  { cmd: "gh api search/code -X DELETE", reason: "gh api -X DELETE" },
  { cmd: "gh api graphql -X DELETE", reason: "gh api -X DELETE" },
  { cmd: "gh api search/code -XDELETE", reason: "gh api -X DELETE" },
  { cmd: "gh api search/code -X=DELETE", reason: "gh api -X DELETE" },
